...
class Pong(World):
    def __init__(self, **kwds):
        ...
        # Linha central
        self.add(draw.RectangleAA(shape=(15, 550), pos=(400, 300), color=(200, 200, 200)))
        ...
        # Cria a barras
        self.pong1 = AABB(shape=[20, 130], pos=(50, 300), world=self, mass='inf')
        self.pong2 = AABB(shape=[20, 130], pos=(750, 300), world=self, mass='inf')
