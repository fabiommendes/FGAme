...
from FGAme.mathutils import Vector, VectorM, RotMatrix, Array
...
class VecArray(MutableSequence):
    ...
    def __init__(self, data):
        ...
        self._data = list(VectorM(x) for x in data)
    ...
    def __iter__(self):
        return iter(Vector(u) for u in self._data)
    ...
    def insert(self, idx, value):
        self._data.insert(idx, VectorM(value))
